...
(async () => {
  ...
  await fs.writeFile("abdominal-hernia-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("abdominal-hernia-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
