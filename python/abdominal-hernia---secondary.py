...
codes = [{"code":"K40","system":"icd10"},{"code":"K41","system":"icd10"},{"code":"K42","system":"icd10"},{"code":"K43","system":"icd10"},{"code":"K45","system":"icd10"},{"code":"K46","system":"icd10"},{"code":"T19.3","system":"opcs4"}];
REQUIRED_CODES = 1;
